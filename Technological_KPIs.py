...
"TGS2": {
    "Name": "Grid Efficiency (Peak Load & Congestion Reduction)",
    "Primary use": "Tracking",
    "Units of measurement": "MWh/year",
    "Description": "The difference between the energy curtailments and peak use before and after the integration of a/all the proposed solutions."
        },
"TGS3": {
